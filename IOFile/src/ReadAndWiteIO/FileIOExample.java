...
//    }
        ...
        public static void main(String[] args) throws IOException {
            writeRandomNumbersToFile("IOFile/src/ReadAndWiteIO/characterData.txt");

            List<Integer> randomList =
                    readRandomNumbersFromFile("IOFile/src/ReadAndWiteIO/characterData.txt");

            writeRandomNumbersDataStream("IOFile/src/ReadAndWiteIO/binaryIOData.bin", randomList);



            List<Integer> dataList =
                    readRandomNumbersDataStream("IOFile/src/ReadAndWiteIO/binaryIOData.bin");
            System.out.println("Are lists equal? " + randomList.equals(dataList));
        }
