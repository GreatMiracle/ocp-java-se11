...
//        Thread doesNothingThread = new ThreadDoesNothing();
//        doesNothingThread.setName("kien1");
//        doesNothingThread.start();
//
//        // Custom Thread implements run(), throws RuntimeException
//        Thread threadDoesSomething = new ThreadDoesSomething();
//        threadDoesSomething.setName("kien2");
//        threadDoesSomething.start();
