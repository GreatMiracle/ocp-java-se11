...
//      if (a++ == 1) {
        ...
        while (--b > 0) {  // Use a prefix decrement b=5-0, 4-1, 3-2, 2-3, 1-x
            loopiterations++; //
        }
        ...
        b = 5;
        loopiterations = 0;
        while (b-- > 0) {  // Use a postfix decrement 5-0,  4-1, 3-2, 2-3, 1-4, 0-x .pha cuối là 1-- tương ứng với 4++ ra ngoài for thì là 0-- tương ứng với 5 (và vòng for này ko vào trong) nhưng b vẫn trừ 1 thì thành -1
            loopiterations++;
        }
