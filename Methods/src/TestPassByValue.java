...
public class TestPassByValue {
    public static void main(String[] args) {
        ...
        System.out.println("Original hashCode: " + stringBuilder.hashCode());
        ...
        // After modification
        System.out.println("\nAfter modification:");
        System.out.println("Modified hashCode: " + stringBuilder.hashCode());
        System.out.println("Modified value: " + stringBuilder);
    ...
    public static void changeValue(Object o1, Object o2) {
        ...
        switch (o1.getClass().getName()) {
            ...
            case ("java.lang.StringBuilder"):
                o1 = ((StringBuilder) o1).append("1xyz");
