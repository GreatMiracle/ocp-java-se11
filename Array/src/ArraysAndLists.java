...
public class ArraysAndLists {
    public static void main(String[] args) {
        ...
        List<String> listWithNull = Arrays.asList("Java", null, "is", null, "cool");
        String[] arrayWithNull = listWithNull.toArray(new String[0]);

        List<Object> mixedList = Arrays.asList("Java", 42, 3.14, null);
        String[] stringArray = mixedList.toArray(new String[0]); // Lỗi tại thời điểm chạy (Runtime Error)
